...
public class Part3Assessor extends BaseTFragment implements MediaPlayer.OnCompletionListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_part3_asses, container, false);
        ...
        ivNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startNewScreen(Part3Assessor.this, new Part4Assessor());
            }
        });
        ...
        ivPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    mediaPlayer.setDataSource(ApiRequest.BASIC_URL + AssessorStartAct.storeresult.getPart_3());
                    mediaPlayer.prepare();
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//                WindowManager.LayoutParams.WRAP_CONTENT);
    ...
    private void setResultExam(){
        lbHeader.setText(AssessorStartAct.storeresult.getPart3_text());
        Glide.with(getActivity()).load(String.valueOf(AssessorStartAct.storeresult.getPart3_url()))
                .asBitmap()
                .fitCenter()
