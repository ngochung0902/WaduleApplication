...
public class Part4Assessor extends BaseTFragment implements MediaPlayer.OnCompletionListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_part4_asses, container, false);
        ...
        ivNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startNewScreen(Part4Assessor.this, new ReviewFragment());
            }
        });
        ...
        ivPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    mediaPlayer.setDataSource(ApiRequest.BASIC_URL + AssessorStartAct.storeresult.getPart_4());
                    mediaPlayer.prepare();
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//                WindowManager.LayoutParams.WRAP_CONTENT);
    ...
    private void setResultExam(){
        lbHeader.setText(AssessorStartAct.storeresult.getPart4_text());
        Glide.with(getActivity()).load(String.valueOf(AssessorStartAct.storeresult.getPart4_url()))
                .asBitmap()
                .fitCenter()
