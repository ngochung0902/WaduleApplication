...
public class Part3 extends BaseTFragment implements View.OnClickListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
...
//                        SimpleDateFormat format = new SimpleDateFormat("EEEddMMyyyy_HHmmss");
                        audiofile3 = new File(Environment.getExternalStorageDirectory() + "/"
...
//                            Toast.makeText(getApplicationContext(),"Please grant camera permission for the app in Settings",Toast.LENGTH_LONG).show();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lbQuestion.setText(String.valueOf(StartAssessmentAct.examObj.getPart3_text()));
        Glide.with(getActivity()).load(String.valueOf(StartAssessmentAct.examObj.getPart3_url()))
                .asBitmap()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .into(ivHobby);
        LakRun.setLayoutView(ivHobby, LakRun.GetWidthDevice(getActivity()) / 2, LakRun.GetWidthDevice(getActivity()) / 2);
        btnRecord.setOnClickListener(this);
        new DelayTask().execute();
        ivNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startNewScreen(Part3.this, new Part4());
            }
        });
...
//            }
    ...
    private void startRecording() {
        ...
        mRecorder.setOutputFile(audiofile3.getAbsolutePath());
