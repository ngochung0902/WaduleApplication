...
import com.wodule.custom.PinnedHeaderListViewCustom;


public abstract class SectionedBaseAdapterCustom extends BaseAdapter implements PinnedHeaderListViewCustom.PinnedSectionedHeaderAdapter {
    ...
    public SectionedBaseAdapterCustom() {
        super();
